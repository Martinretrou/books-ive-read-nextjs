...
// import { map, lerp, clamp, getMousePos } from './hover';
...
//   constructor(el, inMenuPosition, animatableProperties, imageUrl) {
//     if (typeof window !== `undefined`) {
...
//         ease: 'Sine.easeOut',
//         startAt: { x: direction.x < 0 ? '-50px' : '50px' },
//         x: '0%',
//       })
